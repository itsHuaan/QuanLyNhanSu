...
namespace QuanLyNhanSu
{
    public partial class HoSoNhanVien : Form
    {
        ...
        {
            GenericClass.LoadCombobox(connection, GenericClass.selectPhong, comboBox_maphong, "MaPhong", "TenPhong");
            GenericClass.LoadCombobox(connection, GenericClass.selectChucVu, comboBox_machucvu, "MaChucVu", "TenChucVu");
            hoSoNhanVien();
        }
        ...
        private void hoSoNhanVien()
        {
            ...
            if (string.Equals("nam", gioiTinh, StringComparison.OrdinalIgnoreCase))
            {
                pictureBox_anhdaidien.Image = QuanLyNhanSu.Properties.Resources.male;
                radioButton_nam.Checked = true;
            }
            else
            {
                pictureBox_anhdaidien.Image = QuanLyNhanSu.Properties.Resources.female;
                radioButton_nu.Checked = true;
            }
