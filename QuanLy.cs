...
namespace QuanLyNhanSu
{
    public partial class QuanLy : Form
    {
        ...
        {
            GenericClass.changeColor(label_exit, Color.Transparent, SystemColors.Control);
        }

        private void label_minimize_MouseHover(object sender, EventArgs e)
        {
            GenericClass.changeColor(label_minimize, Color.Gray, SystemColors.Control);
        }

        private void label_minimize_MouseLeave(object sender, EventArgs e)
        {
            GenericClass.changeColor(label_minimize, Color.Transparent, SystemColors.Control);
        }
