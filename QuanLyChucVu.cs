...
namespace QuanLyNhanSu
{
    public partial class QuanLyChucVu : Form
    {
        ...
        {
            textBox_machucvu.Text = GenericClass.GenerateRandomString("cv", 10000, 99999);
            if (connection.State != ConnectionState.Open)
                connection.Open();
            GenericClass.LoadData(connection, GenericClass.selectChucVu, dataGridView_chucvu);
        }
        ...
        private void toolStripButton_them_Click(object sender, EventArgs e)
        {
            ...
            {
                decimal heSoPhuCap = decimal.Parse(textBox_hesophucap.Text);
