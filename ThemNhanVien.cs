...
namespace QuanLyNhanSu
{
    public partial class ThemNhanVien : Form
    {
        ...
        {
            textBox_manhanvien.Text = GenericClass.GenerateRandomString("nv", 10000, 99999);
        ...
        private void button_them_Click(object sender, EventArgs e)
        {
            ...
            {
                if (textBox_hoten.Text.Contains(" "))
                {
                ...
                {
                    MessageBox.Show("Tên không hợp lệ.", "Cảnh báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
            else
            {
